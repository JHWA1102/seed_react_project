...
const CoachBase = () => {
    ...
    return(
        <div>
            ...
            <br></br>
            <img src={`${process.env.PUBLIC_URL}/assets/img16.png`} style={{width: "500px", height: "60px"}}></img>
            <ui className="coachBase-list">
                <li className="coachBase-list-sub1">{count}. 운영개요</li>
                <li className="coachBase-list-sub2">대상 : 중, 고등</li>
                <li className="coachBase-list-sub2">유형 : 학교방문형(단기)</li>
                <li className="coachBase-list-sub2">과정 : 1일 3차시</li>
                ...
                <li className="coachBase-list-sub4">{count+1}) 주간목표 수립으로 교과와 비교과간의 균형 잡힌 학교생활을 계획할 수 있다.</li>
                <li className="coachBase-list-sub4">{count+2}) 일일 단위로 계획의 우선순위를 설정하여 실행할 수 있다.</li>
                <li className="coachBase-list-sub4">{count+3}) 피드백의 과정을 거쳐 자신이 작성한 계획을 점검·수정할 수 있다.</li>
                <li className="coachBase-list-sub4">{count+4}) 습관이 주는 유익을 이해하고, 지속가능한 학습 습관을 형성할 수 있다.</li>
                <hr style={{border: "0", height: "0.5px", background: "#bbb", marginTop: "40px"}}></hr>
                <li className="coachBase-list-sub1">{count+2}. 교육 커리큘럼</li>
                <li className="coachBase-list-sub3">({count}) 교육 계획</li>
                <div style={{float: "left", width: "50%"}}>
                <li className="coachBase-list-sub2">1교시 - 눈으로 직접 확인하고 인식하는 주간플래닝 (주간시간설계표)</li>
                <li className="coachBase-list-sub2">2교시 - 균형 잡힌 학교생활을 위한 주간플래닝 (주간목표, 일일계획, 피드백)</li>
                <li className="coachBase-list-sub2">3교시 - 지속 가능한 실행을 위한 습관 형성 프로젝트 & 수업 회고</li>
                </div>
                <div style={{float: "right", width: "45%", marginTop: "-55px"}}>
                    <li className="coachBase-list-sub3">({count+1}) 세부내용 안내</li>
                    <img src={`${process.env.PUBLIC_URL}/assets/img17.jpg`} style={{width: "450px"}}></img>
                </div>
            </ui>
            <br></br>
